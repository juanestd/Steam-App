    ...
    sections.forEach((section, index) => {
        const buttonTemplate = `
            <div class="col-md-4 mb-3">
                <button class="btn-custom btn-block" onclick="showSection(${index})">${section.title}</button>
            </div>
        `;
